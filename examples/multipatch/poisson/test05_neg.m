...
function defeaturing_data = set_defeaturing_data(problem_data)
    defeaturing_data.omega_star_patches_in_omega0 = 1:3;

    defeaturing_data.gamma_n_sides_in_omega = [5 7];
    defeaturing_data.gamma_n_sides_in_omega0.patch = [2 3];
    defeaturing_data.gamma_n_sides_in_omega0.local_side_in_patch = [4 2];
